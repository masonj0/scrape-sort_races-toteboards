...
**ROLE:** A rich, read-only, terminal-based dashboard for development, testing, and headless operational monitoring. This is a **companion tool**, not part of the core server application.
